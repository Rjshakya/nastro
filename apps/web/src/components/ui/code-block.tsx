import React, { type FC, use, useState } from "react";
  ...
  ({
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "flex items-center justify-between border-b px-4 py-1",
        ...
        <div className="overflow-x-auto">
          {highlightedHtml ? (
            <div className="flex">
              {showLineNumbers && (
                <div className="shrink-0 py-4 pl-4 pr-2 select-none text-right text-sm text-zinc-400 dark:text-zinc-600">
                  {lines.map((_, i) => (

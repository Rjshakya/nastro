/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 4a85e908418ae76a614b2977f6e91073)
// Runtime types generated with workerd@1.20260424.1 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_PUBLIC_CLIENT_URL: string;
		VITE_PUBLIC_GOOGLE_FONTS_API_KEY: string;
		VITE_PUBLIC_ENVIRONMENT: string;
		API_URL: string;
		CLIENT_URL: string;
		GOOGLE_FONTS_API_KEY: string;
		ENVIRONMENT: string;
		NASTRO_API_WORKER: Fetcher /* nastro-api */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_PUBLIC_API_URL" | "VITE_PUBLIC_CLIENT_URL" | "VITE_PUBLIC_GOOGLE_FONTS_API_KEY" | "VITE_PUBLIC_ENVIRONMENT" | "API_URL" | "CLIENT_URL" | "GOOGLE_FONTS_API_KEY" | "ENVIRONMENT">> {}
}

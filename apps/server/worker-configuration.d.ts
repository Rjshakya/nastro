/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f2725cb512b8b408ab564292de83696c)
// Runtime types generated with workerd@1.20260521.1 2026-02-24 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	NASTRO_KV: KVNamespace;
	TEMPLATES_BUCKET: R2Bucket;
	SITES_BUCKET: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	SITE_READ_LIMITER: RateLimit;
	SITE_WRITE_LIMITER: RateLimit;
	NOTION_PAGES_API_READ_LIMITER: RateLimit;
	...
	SITE_ASSETS_BUCKET_ENDPOINT: string;
	TEMPLATE_ASSETS_BUCKET_ENDPOINT: string;
	SITE_ASSETS_BUCKET_PROD_URL: string;
	TEMPLATE_ASSETS_BUCKET_PROD_URL: string;
	CLOUDFLARE_NASTRO_ZONE_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATABASE_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "NOTION_CLIENT_ID" | "NOTION_CLIENT_SECRET" | "CLIENT_URL" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "SITE_ASSETS_BUCKET_ENDPOINT" | "TEMPLATE_ASSETS_BUCKET_ENDPOINT" | "SITE_ASSETS_BUCKET_PROD_URL" | "TEMPLATE_ASSETS_BUCKET_PROD_URL" | "CLOUDFLARE_NASTRO_ZONE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_ZONE_ID" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "NODE_ENV">> {}
}

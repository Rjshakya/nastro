...
export const processBlock =
  ...
  async (f: () => Client): Promise<unknown> => {
    const b = block();
 ...
 * Returns array of processed blocks (without children - those are handled by processBlockRecursively)
 */
// export const processBlocks =
//   (blocks: () => BlockObjectResponse[]) => (): unknown[] => {
//     const blockArray = blocks();
//     return blockArray.map((block) => processBlock(() => block)());
//   };
